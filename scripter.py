...
class Scripter(tk.Tk):
    ...
    def _bind_keys(self):
        ...
        # NOTE: On Windows, Tk silently ignores the unsupported "Command"
        # modifier, so a binding like <Command-s> fires on a bare "s"
        # keypress. Therefore: Command shortcuts ONLY on macOS (aqua);
        # everywhere else, Control alone.
